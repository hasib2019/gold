        ...
        <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
          <div class="auth-box h-full flex flex-col justify-center">
            <div class="mobile-logo text-center mb-6 lg:hidden block">
                <a href="/">
                    <img src="gold/logo.jpeg" alt="" class="mx-auto">
                    {{-- <img src="gold/logo.jpeg" alt="" class="mx-auto"> --}}
                  </a>
            </div>
            <div class="text-center 2xl:mb-10 mb-4">
              ...
              <div class="text-slate-500 dark:text-slate-400 text-base">
                Sign up to your account to start using Crystal Gold
              </div>
            </div>
          ...
          <div class="auth-footer text-center">
            Copyright 2023, Dashcode All Rights Reserved.
          </div>
        </div>
      </div>
      <div class="left-column bg-cover bg-no-repeat bg-center " style="background-image: url(gold/Crystal.png);">
